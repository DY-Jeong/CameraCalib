...
namespace CameraCalib
{
    public class CamConfig
    {
        ...
        public OpenCvSharp.Mat getCamMat()
        {
            return cam_mat;
        }
        public OpenCvSharp.Mat getDistCoeffs()
        {
            return dist_coeffs;
        }
        public OpenCvSharp.Size getImageSize()
        {
            return image_size;
        }
        public bool read_from_file(string path)
        {
            OpenCvSharp.FileStorage file = new OpenCvSharp.FileStorage();
            file.Open(path, OpenCvSharp.FileStorage.Modes.Read);
            ...
            {
                image_size.Height=file["image_height"];
            }
            return true;
        }
